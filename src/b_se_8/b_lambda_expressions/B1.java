...
public class B1 {
	public static void main(String[] args) {
		...
		Interface1 obj12 = () -> System.out.println("interface 1 by lambda expression");
		obj12.display();
		...
		Interface2 obj22 = (a) -> System.out.println("interface 2 by lambda expression : " + a); 
		obj22.display(20);
		...
		Interface3 obj31 = new Interface3() {
			...
			public void display(int a, int b) {
				System.out.println("interface 3 by anonymous inner class : " + a + " : " + b );
			}
		};
		obj31.display(100, 200);
		
		Interface3 obj32 = (a, b) -> System.out.println("interface 3 by lambda expression : " + a + " : " + b );
